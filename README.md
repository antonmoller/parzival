...
* [`src/cljs/parzival/`](src/cljs/parzival/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/parzival/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `parzival` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/parzival/config.cljs) defaults to `true` in
...
```clj
(ns parzival.example
  (:require [parzival.config :as config])
